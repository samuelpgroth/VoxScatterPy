# Mie series for acoustic scattering of plane wave by sphere
...
rGammaS = a;
DomainR = rGammaR;
xmin,xmax,ymin,ymax=[-DomainR,DomainR,-DomainR,DomainR];
...
circle2 = plt.Circle((0, 0), a/2, color='black', fill=False)
